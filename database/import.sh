...
data_file=${data_file:-/dgraph/import/g01.rdf.gz}
schema_file=${schema_file:-/dgraph/import/g01.schema.gz}
...
if [ ! -d ./server1/import ]; then
    mkdir ./server1/import
fi

cp ${data_file/\/dgraph\//} server1/import/ && cp ${schema_file/\/dgraph\//} server1/import/
